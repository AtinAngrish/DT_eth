...
class stateWatcher:
    ...
    def on_change(self,delta): # do stuff when variable changed
        print('changed')
...
def on_message(client, userdata, msg):
    print('on message')
    current_line, mach_status = msg.payload.decode().replace('(', '').replace(')', '').split(', ')
    mach_status = str(mach_status.replace("'", ""))
